...
|                      | `DXVK_HDR`                     | Enables HDR when set to `DXVK_HDR=1`, optionally combined with `ENABLE_HDR_WSI=1` if required, on Nvidia driver versions older than `595.x.x`. Need to also set `PROTON_ENABLE_WAYLAND=1` for this to work.                                                                                                                                                                                                                                                                                                              |
