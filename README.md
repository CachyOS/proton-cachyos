...
| `vkd3dlowlatency`    | `PROTON_VKD3D_LOWLATENCY`      | Use the [vkd3d-low-latency](https://github.com/netborg-afps/vkd3d-low-latency) fork of `vkd3d-proton`, which adds low-latency frame pacing for Direct3D 12 with a native Reflex implementation and Waitable DXGI Swapchains to reduce input lag. Read the [status and limitations](https://github.com/netborg-afps/vkd3d-low-latency#status--limitations) first. Configuration options are in the [documentation](https://github.com/netborg-afps/vkd3d-low-latency?tab=readme-ov-file#vkd3d-low-latency). |
